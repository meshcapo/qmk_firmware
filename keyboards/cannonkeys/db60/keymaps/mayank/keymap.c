...
#define HYPRTRM LGUI(KC_ENT)    // Win + Enter: open terminal
...
#define ZENWSC0 LCA(KC_0)       // Move to Zen workspace 10
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_60_ansi(
    ...
    KC_LALT, MO(1),   KC_LGUI,                            KC_SPC,                            MO(2),   MO(3),   KC_PGUP, KC_PGDN
  ),

  [1] = LAYOUT_60_ansi(
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F1,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  UNLOCK,
    _______, KILLWIN, _______, _______, VSPYTHN, GTIMAIL, _______, UNCOMMT, GT_ISE,  _______, PASSWD1, _______, _______, _______,
    _______, PASSWD2, UCMAIL,  DLTBRKS, _______, GMAIL1,  _______, _______, _______, PRVSRCH, _______, NXTSRCH,          _______,
    _______, _______, _______, COMMENT, _______, BUILD,   NOBUILD, GMAIL2,  _______, _______, _______,                   _______,
    _______, _______, _______,                            _______,                            _______, _______, _______, QK_BOOT
  ),

  [2] = LAYOUT_60_ansi(
    _______, MVESPC1, MVESPC2, MVESPC3, MVESPC4, MVESPC5, MVESPC6, MVESPC7, MVESPC8, MVESPC9, UNLCODE, _______, _______, TASKMGR,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_UP,   _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT,          HYPRTRM,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
    _______, _______, _______,                            _______,                            _______, _______, _______, _______
  ),

  [3] = LAYOUT_60_ansi(
    _______, ZENWSC1, ZENWSC2, ZENWSC3, ZENWSC4, ZENWSC5, ZENWSC6, ZENWSC7, ZENWSC8, ZENWSC9, ZENWSC0, _______, _______, _______,
    _______, ZENSPTQ, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, ZENSPTH, _______, _______, ZENPREV, _______, ZENNEXT,          _______,
    _______, _______, _______, _______, ZENSPTV, _______, _______, _______, _______, _______, _______,                   _______,
    _______, _______, _______,                            _______,                            _______, _______, _______, _______
  )
};
