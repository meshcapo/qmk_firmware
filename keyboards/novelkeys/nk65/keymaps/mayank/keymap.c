...
#define TASKMGR LCA(KC_DEL)     // Ctrl + Alt + Delete (launch task manager)
#define GT_ISE  MEH(KC_I)       // Ctrl + Shift + Alt + I (launch GT-ISE)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi( /* Base layer */
        QK_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_HOME,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_PGUP,
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGDN,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_END,
        KC_LGUI, MO(1),   KC_LALT,                   WINSPC,                             MO(2),   MO(3),   KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [1] = LAYOUT_65_ansi( /* Windows/VS layer */
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, QK_BOOT,
        _______, KILLWIN, _______, _______, VSPYTHN, GTIMAIL, _______, UNCOMMT, GT_ISE,  _______, PASSWD1, _______, _______, _______, _______,
        _______, PASSWD2, UCMAIL,  _______, DLTBRKS, GMAIL1,  _______, _______, _______, _______, LOCKSCR, _______,          _______, _______,
        _______, _______, _______, COMMENT, _______, BUILD,   NOBUILD, GMAIL2,  _______, _______, _______, _______,          _______, _______,
        _______, _______, _______,                   _______,                            _______, _______, _______, PRVSRCH, _______, NXTSRCH
    ),

    [2] = LAYOUT_65_ansi( /* Zen browser layer */
        _______, ZENWSC1, ZENWSC2, ZENWSC3, ZENWSC4, ZENWSC5, ZENWSC6, ZENWSC7, ZENWSC8, ZENWSC9, _______, _______, _______, _______, _______,
    ...
    [3] = LAYOUT_65_ansi( /* FN */
        _______, MVESPC1, MVESPC2, MVESPC3, MVESPC4, MVESPC5, MVESPC6, MVESPC7, MVESPC8, MVESPC9, UNLOCK,  _______, _______, TASKMGR, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, LOCKSCR, _______, _______,          _______, _______,
